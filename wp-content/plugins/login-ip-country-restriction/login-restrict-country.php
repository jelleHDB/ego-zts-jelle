...
define( 'SISANU_RCIL_CURRENT_DB_VERSION', 6.30 );
	...
	public static function plugin_admin_notices() {
		...
		if ( ! empty( $maybe_trans ) ) {
			...
			$other_notice = sprintf(
				// Translators: %1$s - extensions URL.
				__( 'Check out my other <a href="%1$s" target="_blank">%2$s free plugins</a> on WordPress.org and the <a href="%3$s" target="_blank">%4$s premium extensions</a> available!', 'slicr' ),
			...
			<div id="item-<?php echo esc_attr( $slug ); ?>" class="updated notice">
				<a href="<?php echo esc_url( self::$plugin_url ); ?>" class="icon"><img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '/assets/images/icon-128x128.gif' ); ?>"></a>
				<div class="content">
					<div>
						<h3>
							<?php
						...
						<?php echo wp_kses_post( $maybe_pro ); ?>
					...
					<div>
						...
						echo wp_kses_post( sprintf(
							...
							__( 'This plugin is free to use, but not to operate. Please consider supporting my services by making a <a href="%1$s" target="_blank">donation</a>. It would make me very happy if you would leave a %2$s rating. %3$s', 'slicr' ),
							$donate,
						...
						?>
						<a class="notice-plugin-donate" href="<?php echo esc_url( $donate ); ?>" target="_blank"><img src="<?php echo esc_url( plugin_dir_url( __FILE__ ) . '/assets/images/buy-me-a-coffee.png?v=' . SISANU_RCIL_CURRENT_DB_VERSION ); ?>" width="280"></a>
					</div>
				</div>
			...
			if ( ! self::$is_pro ) {
				echo wp_kses_post(
					sprintf(
						...
						__( 'If you find the plugin useful and would like to support my work, please consider making a <a href="%1$s" target="_blank">donation</a>. <br>It would make me very happy if you would leave a %2$s rating. %3$s', 'slicr' ),
